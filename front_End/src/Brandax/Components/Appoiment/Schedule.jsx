          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-10">
            ...
            <div>
              ...
              <p className="text-base md:text-lg leading-8 max-w-xl">
                ...
                evolved into a leading digital marketing company in Kerala
                by diversifying our services over the period. Our
                professionals explore and exploit the digital arena to
                attain incredible results for our clientele.
              </p>
            </div>
      ...
      <div className="w-full bg-[#397ABF]/60 py-16 px-5 md:px-10 lg:px-20">
        ...
        <div className="max-w-6xl">
          ...
          <p className="leading-8 text-base md:text-lg mb-10">
            ...
            worldwide. Our expertise includes visually appealing web
            designs, SEO, paid ads, graphic design, and effective digital
            marketing solutions that improve search engine rankings.

            Our experienced team starts by understanding your business
            goals and strategies, delivering optimal solutions for growth.
            We prioritize client satisfaction through innovative ideas,
            rigorous testing, and on-time delivery.
          </p>
